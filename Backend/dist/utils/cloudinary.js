...
const uploadOnCloudinary = (localFilePath) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        fs_1.default.unlinkSync(localFilePath); // remove locally saved file after uploading to cloudinary
        return response;
    }
    catch (error) {
        console.log("Error: ", error);
        fs_1.default.unlinkSync(localFilePath); // remove locally saved file as the upload operation failed
        return null;
    }
});
